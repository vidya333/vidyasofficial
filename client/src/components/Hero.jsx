      ...
      <div className="container relative z-10 pt-10 pb-20 px-5 md:px-6">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full border font-mono text-[13px] no-underline transition-all duration-200"
            style={{
          ...
          >
            {/* Google G — inline SVG, no external dependency */}
